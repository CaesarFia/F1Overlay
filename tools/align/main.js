...
const camera = new THREE.OrthographicCamera(-25, 25, 14, -14, 0.1, 200);camera.position.set(0, 60, 0);camera.lookAt(0, 0, 0);scene.add(new THREE.AmbientLight(0xffffff, 0.8));
